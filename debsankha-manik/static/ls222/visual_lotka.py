...
class gui_display:
	def __init__(self):
		self.gladefile='/home/nofrills/programs/ls222/lvshort.glade'
		self.wTree = gtk.glade.XML(self.gladefile)
		dic={"on_start_clicked":self.dynamics,"on_mainwin_destroy":gtk.main_quit}
		self.wTree.signal_autoconnect(dic)
		self.wTree.get_widget("mainwin").show()
		self.wTree.get_widget("image").set_from_file("/home/nofrills/programs/ls222/start.png")
...
#	while True:
	...
	def dynamics(self,*args,**kwargs):
		self.wTree.get_widget("image").set_from_file("/home/nofrills/programs/ls222/wait.png")
